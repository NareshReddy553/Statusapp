...
class Businessunits(models.Model):
    businessunit_id = models.AutoField(db_column="BUSINESSUNIT_ID", primary_key=True)
    businessunit_name = models.CharField(
        db_column="BUSINESSUNIT_NAME",
        unique=True,
        max_length=200,
        null=False,
        blank=False,
    ...
    modify_datetime = models.DateTimeField(db_column="MODIFIED_DATETIME", auto_now=True)
...
class Components(models.Model):
    ...
    component_name = models.CharField(db_column="COMPONENT_NAME", max_length=500)
    ...
    subgroup_display_order = models.IntegerField(db_column="SUBGROUP_DISPLAY_ORDER")
    ...
    has_subgroup = models.BooleanField(db_column="HAS_SUBGROUP", blank=True, null=True)
...
class Incidents(SoftDeleteModelMixin):
    ...
    incident_postmortem = models.CharField(max_length=2000, blank=True, null=True)
...
class Subscribers(models.Model):
    subscriber_id = models.AutoField(db_column="SUBSCRIBER_ID", primary_key=True)
    first_name = models.CharField(
        db_column="FIRST_NAME", max_length=200, blank=True, null=True
    )
    ...
    subscriber_token = models.CharField(
        db_column="SUBSCRIBER_TOKEN", max_length=100, editable=False
    )
...
class UserBusinessunits(models.Model):
    ...
    user = models.ForeignKey(Users, on_delete=models.CASCADE, related_name="usr_bs")
    ...
    allow_access = models.BooleanField(db_column="ALLOW_ACCESS", blank=True, null=True)
    created_datetime = models.DateTimeField(
...
class IncidentsActivity(models.Model):
    ...
    modified_datetime = models.DateTimeField(blank=True, null=True, auto_now_add=True)
...
class ScheduledMaintenance(models.Model):
    ...
    message = models.CharField(max_length=2000, blank=True, null=True)
    is_active = models.BooleanField(blank=True, null=True, default=True)
    schstartdate = models.DateTimeField(
        db_column="schStartDate", blank=False, null=False
    )
    ...
    status = models.CharField(
        max_length=100, blank=True, null=True, default="Scheduled"
    )
